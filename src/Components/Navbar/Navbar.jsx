    ...
    <nav className="bg-gradient-to-r from-black via-gray-900 to-gray-800 shadow-lg sticky top-0 z-50">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 w-full text-white space-x-6">
          ...
          <span
            ...
            className="text-2xl font-extrabold tracking-wider text-red-500 hover:text-white cursor-pointer transition duration-300"
          >
            Bike Doctors
          </span>
      ...
      {isOpen && (
        <div className="md:hidden px-6 pb-4 space-y-3 bg-gray-900 rounded-b-lg shadow-inner absolute w-full top-16 left-0 z-50">
          ...
          <span
            onClick={() => scrollToSection("contact")}
            className="block bg-red-500 text-white font-semibold px-4 py-2 rounded-lg shadow hover:bg-white hover:text-red-600 text-center transition duration-300 cursor-pointer"
          >
            Book Now
          </span>
        </div>
